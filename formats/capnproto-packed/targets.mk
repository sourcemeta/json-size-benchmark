# Use the schema schema from capnproto

$(OUTPUT)/documents/%/capnproto-packed/output.bin: \
	$(OUTPUT)/documents/%/capnproto-packed/input.json benchmark/%/capnproto/schema.capnp \
...
$(OUTPUT)/documents/%/capnproto-packed/output.json: \
	$(OUTPUT)/documents/%/capnproto-packed/output.bin benchmark/%/capnproto/schema.capnp \
	| $(OUTPUT)/documents/%/capnproto-packed
