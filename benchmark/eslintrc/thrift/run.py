def encode(json, schema):
    ...
    payload.ecmaFeatures = schema.EcmaFeatures()
    payload.ecmaFeatures.jsx = json['ecmaFeatures']['jsx']
    payload.plugins = json['plugins']
    payload.env = schema.Environment()
    ...
    payload.rules.validJsdoc = [
        schema.JSDocRule(),
        schema.JSDocRule()
    ]

    payload.rules.validJsdoc[0].numeric = json['rules']['valid-jsdoc'][0]
    payload.rules.validJsdoc[1].options = schema.JSDocOptions()
