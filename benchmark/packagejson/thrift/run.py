def encode(json, schema):
    ...
    payload.repository = schema.Repository()
    payload.repository.type = json['repository']['type']
    payload.repository.url = json['repository']['url']
    payload.bugs = schema.Bugs()
    payload.bugs.url = json['bugs']['url']
    payload.licenses = [schema.License()]
    payload.licenses[0].type = json['licenses'][0]['type']
    payload.licenses[0].url = json['licenses'][0]['url']
    payload.main = json['main']
    payload.scripts = schema.Scripts()
    payload.scripts.test = json['scripts']['test']
    payload.engines = schema.Engines()
    ...
    payload.devDependencies = schema.DevDependencies()
